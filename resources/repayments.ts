import { BaseListParams, Meta, UnitConfig, UnitResponse } from "../types"
import { Repayment, CreateRepaymentRequest } from "../types/repayments"
...
export class Repayments extends BaseResource {
    ...
    public async get(repaymentId: string): Promise<UnitResponse<Repayment>> {
        return this.httpGet<UnitResponse<Repayment>>(`/${repaymentId}`)
    }
