...
export interface EvaluationParams {
    /**
     * Optional. Decide when to request a selfie verification document. One of: Never, ReplaceIdentification, Always.
     */
    useSelfieVerification?: "ReplaceIdentification" | "Never" | "Always";
